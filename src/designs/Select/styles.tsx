...
export const ListboxOptionsContainer = styled(Listbox.Options)`
  ${tw`absolute z-30 w-full py-1 mt-1 overflow-auto border rounded-lg shadow-md bg-primary-1 max-h-60 focus:outline-none border-neutral-4`}
`;
...
export const MenuButton = styled.div<{
  ...
  ${({ isError, disabled }) =>
    formControlCommon(isError, disabled)}
